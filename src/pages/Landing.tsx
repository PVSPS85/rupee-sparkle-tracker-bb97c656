...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      <ShootingStars enabled={settings.particlesEnabled} starCount={12} />
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="glass-card p-6 rounded-xl group hover:border-primary/30 transition-all duration-300 hover:-translate-y-1 hover-lift"
              >
      ...
      <section className="relative z-10 container mx-auto px-4 py-20">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="glass-card border-primary/30 rounded-2xl p-12 text-center relative overflow-hidden"
        >
